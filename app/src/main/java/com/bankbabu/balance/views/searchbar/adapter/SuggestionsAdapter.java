 ...
 * @param <V> viewholder
 */
public abstract class SuggestionsAdapter<S, V extends RecyclerView.ViewHolder> extends
    RecyclerView.Adapter<V> implements Filterable {
  ...
  //FIXME: Hotfix. Cannot reproduce IndexOutOfBoundsException
  @Override
