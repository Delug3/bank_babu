package com.bankbabu.balance.views.searchbar;
...
import com.bankbabu.balance.views.searchbar.adapter.DefaultSuggestionsAdapter;
...
public class MaterialSearchBar extends RelativeLayout implements View.OnClickListener,
  ...
  private void init(AttributeSet attrs) {
    ...
    roundedSearchBarEnabled = array
        .getBoolean(R.styleable.MaterialSearchBar_mt_roundedSearchBarEnabled, false);
    menuDividerEnabled = array
        .getBoolean(R.styleable.MaterialSearchBar_mt_menuDividerEnabled, false);
    ...
    searchIconTintEnabled = array
        .getBoolean(R.styleable.MaterialSearchBar_mt_searchIconUseTint, true);
    arrowIconTintEnabled = array.getBoolean(R.styleable.MaterialSearchBar_mt_backIconUseTint, true);
    clearIconTintEnabled = array
        .getBoolean(R.styleable.MaterialSearchBar_mt_clearIconUseTint, true);
    borderlessRippleEnabled = array
        .getBoolean(R.styleable.MaterialSearchBar_mt_borderlessRippleEnabled, false);
  ...
  /**
   * sets the speechMode for the search bar. If set to true, microphone icon will display instead of
   * the search icon. Also clicking on this icon will trigger the callback method onButtonClicked()
   *
  ...
  private void setupIconRippleStyle() {
    if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
      ...
      if (borderlessRippleEnabled && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        getContext().getTheme()
            .resolveAttribute(android.R.attr.selectableItemBackgroundBorderless, rippleStyle, true);
      } else {
        getContext().getTheme()
            .resolveAttribute(android.R.attr.selectableItemBackground, rippleStyle, true);
      }
  ...
  /**
   * For calculate the height change when item delete or add animation false is return the full
   * height of item, true is return the height of position subtraction one
   *
...
//      disableSearch();
  ...
  public interface OnSearchActionListener {
     ...
     *
     * @param buttonCode {@link #BUTTON_NAVIGATION}, {@link #BUTTON_SPEECH} or {@link #BUTTON_BACK}
     * will be passed
     */
