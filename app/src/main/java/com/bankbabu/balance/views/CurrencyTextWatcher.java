...
class CurrencyTextWatcher implements TextWatcher {
  ...
  /**
   * After each letter is typed, this method will take in the current text, process it, and take the
   * resulting formatted string and place it back in the EditText box the TextWatcher is applied to
   *
  ...
  private String formatAsCurrency(String newText) {
    return CurrencyTextFormatter
        .formatText(newText, editText.getLocale(), editText.getDefaultLocale(),
